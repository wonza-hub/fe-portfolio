...
export default function TechStacks() {
  return (
    <div className="container mx-auto h-full py-24 pt-12">
      ...
      <div className="scrollbar-hide h-full space-y-8 overflow-auto px-6 py-10 target:px-8">
        ...
        <div
          className={`pointer-events-none absolute bottom-10 left-0 h-36 w-full bg-gradient-to-t from-white to-transparent`}
        />
      </div>
    </div>
  );
